...
public class View {
    ...
    public void runFakeExecution() {
        ...
        String out = contr.registerItem("Tomat", new Amount(1));
        System.out.println(out);
        out = contr.registerItem("Gurka", new Amount(4));
        System.out.println(out);
        out = contr.registerItem("Tomat", new Amount(5));
        System.out.println(out);
        out = contr.registerItem("Apelsin", new Amount(20));
        System.out.println(out);
        out = contr.registerItem("Paprika", new Amount(2));
        System.out.println(out);
